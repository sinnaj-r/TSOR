...
export const settingsInitialState: SettingsState = {
  graphUrl: `https://team-bp-configurable-graphlet.cfapps.eu10.hana.ondemand.com`,
  // 'https://sapgraph-configurable-graphlet.cfapps.eu10.hana.ondemand.com', // 'https://sandbox.graph.sap/api/beta',
  graphLandscape: 'Demo',
  authToken: '',
